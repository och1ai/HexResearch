...
public class HexResearchAbstractions {
     ...
     * Example:
     * <p>
     * Expect: name.dashkal.minecraft.hexresearch.HexResearchAbstractions#getConfigDirectory()
     * <p>
     * Actual Fabric: name.dashkal.minecraft.hexresearch.fabric.HexResearchAbstractionsImpl#getConfigDirectory()
     * <p>
     * Actual Forge: name.dashkal.minecraft.hexresearch.forge.HexResearchAbstractionsImpl#getConfigDirectory()
     * <p>
